...
- 解决方案与服务
  - 解决方案
    ...
    - 数字疗法 （朴慧的方案介绍）
    - 智慧零售 （无人零售的相关方案）
    - 电商数字化赋能方案 （结合电商出海，数字化平台，数据治理，数据质量提升，数据化赋能，AI战略等应用场景）
  - 咨询和服务
    - 数字化咨询服务（个比较宽泛，需要细化到AI agent 的方案介绍）
    - 系统设计研发
    - 用户体验设计 （中银国际的方案介绍）
    - AI应用开发 （中行的方案介绍）
- 速睿产品系列
  - 智能制造-数字织机
  - TempoSnap时影-重新想象你自己，定义每一面精彩。Your Self, Reimagined. Define your every side.捕捉光影的瞬间，重塑你的万象。
  - TempoFlow节律-听懂身体的节奏，找回你的心流。
- 客户案例
- 关于我们